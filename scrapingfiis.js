// ============================================================
// scrapingfiis.js
// Extrai TODOS os indicadores disponíveis para FIIs (até 30)
// ============================================================
...
async function scrapingFIIs(ticker) {
  ...
  const resultado = {
    ticker: ticker,
    indicadores: {}, // Todos os indicadores encontrados
    totalEncontrados: 0,
  ...
  try {
    ...
    for (const bloco of blocos) {
      ...
      // Remove textos longos e desnecessários (descrições, tooltips)
      if (titulo.includes("\n")) {
        titulo = titulo.split("\n")[0].trim();
      }
